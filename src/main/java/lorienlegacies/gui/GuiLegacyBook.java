...
{	
	...
	public GuiLegacyBook()
	{
		...
		// FAQ
		pageList.add(new Page("§1§n§lFAQ", new String[] {"The following pages", "serve as an FAQ", "for the mod.", "", "§nQuestions:", "", "How do I get legacies?", "How do I use them?", "What of abilities?", "Are there keybinds?", "Stamina and XP", "Legacy generation", "Is there a config?"}));
